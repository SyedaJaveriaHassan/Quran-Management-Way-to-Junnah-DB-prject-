 ...
 * @author Javeria
 */
public class Surah extends javax.swing.JFrame {
    ...
    public Surah() {
	 ...
	 private void tableLoad() {
		 try{
	            ...
	            ResultSet rs = stmt.executeQuery("select SURAH_ID,SURAH from HR.SURAH where SURAH_NAME='"+selected5+"'");
	            ...
	            while(rs.next()){
	                ...
	                for(int i = 1; i <= c; i++){
                                v2.add(rs.getInt("SURAH_ID"));
                                v2.add(rs.getString("SURAH"));
	                }
	                df.addRow(v2);
	            }
	        }
	      ...
	      //System.out.println(e.toString());
	        System.out.println("Display Result for:"+" "+selected5);
	        }
        initComponents();
    }
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        try{
            java.sql.Connection mycon = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe","system","oracle");
            Statement stmt = mycon.createStatement();
            PreparedStatement ps = mycon.prepareStatement("select SURAH_ID,SURAH from HR.SURAH where SURAH_NAME='"+selected5+"'");
            ResultSet rs = ps.executeQuery();
            DefaultTableModel tm = (DefaultTableModel)jTable1.getModel();
            tm.setRowCount(0);
            while (rs.next())
            {
                Object o[]={rs.getString("SURAH_ID"),
                    rs.getString("SURAH")
                };
                tm.addRow(o);
            }
        ...
        //        jTable1.setModel(new DefaultTableModel(
            //            new Object[][] {
                //            },
            //            new String[] {
                //                "JUZZ_ID","JUZ_NAME","JUZZ_START","JUZZ_END","JUZZ"
                //            }
            //        ) {
            ...
            //            public boolean isCellEditable(int row, int column) {
                ...
                //            }
            // });
    // jTable1.setFont(new Font("Times New Roman", Font.PLAIN, 17));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Surah.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
