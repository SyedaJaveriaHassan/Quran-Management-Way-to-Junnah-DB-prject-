...
public static String selected;
    ...
    public Para() {
	 ...
	 private void tableLoad() {
		 try{
	            ...
	            ResultSet rs = stmt.executeQuery("select JUZZ_START,JUZZ_END,JUZZ from HR.JUZ where JUZ_NAME='"+selected+"'");
	            ...
	            while(rs.next()){
	                ...
	                for(int i = 1; i <= c; i++){
                                v2.add(rs.getString("JUZZ_START"));
                                v2.add(rs.getString("JUZZ_END"));
                                v2.add(rs.getLong("JUZZ"));
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
	    ...
	    Statement stmt = mycon.createStatement();
            ...
            PreparedStatement ps = mycon.prepareStatement("select JUZZ_START,JUZZ_END,JUZZ from HR.JUZ where JUZ_NAME='"+selected+"'");
	    ResultSet rs = ps.executeQuery();
            DefaultTableModel tm = (DefaultTableModel)jTable1.getModel();
            tm.setRowCount(0);
            while (rs.next())
            {
                Object o[]={rs.getString("JUZZ_START"),
                rs.getString("JUZZ_END"),
                rs.getString("JUZZ")
                };
                tm.addRow(o);
            }
