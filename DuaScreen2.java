 ...
 * @author Javeria
 */
public class DuaScreen2 extends javax.swing.JFrame {
static String selected7;
    /**
     * Creates new form DuaScreen2
     */
    public DuaScreen2() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 110, 730, 370));
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        try{
           ...
           // PreparedStatement ps = mycon.prepareStatement("select NAMES from HR.ALLAH_NAMES where NAME_ID='"+selected7+"'");
            //ResultSet rs = ps.executeQuery();
             PreparedStatement ps =mycon.prepareStatement("select mood_ID from HR.mood_detection where mood_name='"+selected7+"'");
             ResultSet rs = ps.executeQuery();
                    int t=0;
	           if(rs.next()){
                       t=rs.getInt("mood_id");
                  ...
                  PreparedStatement ps1 =mycon.prepareStatement("select dua_text from HR.DUA where mood='"+t+"'");
                      ResultSet rs1= ps1.executeQuery();
            DefaultTableModel tm = (DefaultTableModel)jTable1.getModel();
            tm.setRowCount(0);
            while (rs1.next())
            {
                Object o[]={rs1.getString("DUA_TEXT")
                };
                tm.addRow(o);
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DuaScreen2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DuaScreen2().setVisible(true);
            }
        });
    }
