 ...
 * @author Javeria
 */
public class NamesOfAllahFurtherScreen2 extends javax.swing.JFrame {
static String selected9;
    /**
     * Creates new form NamesOfAllahFurtherScreen2
     */
    public NamesOfAllahFurtherScreen2() {
        tableLoad();
	 ...
	 private void tableLoad() {
		 try{
	            ...
	            ResultSet rs = stmt.executeQuery("select NAME_ID,DESCRIPTION from HR.ALLAH_NAMES where NAMES='"+selected9+"'");
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        // TODO add your handling code here:
        NamesOfAllahScreen qs = new NamesOfAllahScreen();
        qs.show();
        dispose();
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        try{
            ...
            PreparedStatement ps = mycon.prepareStatement("select NAME_ID,DESCRIPTION from HR.ALLAH_NAMES where NAMES='"+selected9+"'");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NamesOfAllahFurtherScreen2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NamesOfAllahFurtherScreen2().setVisible(true);
            }
        });
    }
